...
# Importing api clients, when have acess to API would be real
...
# Fake user will want to add real profile section later
...
def index():
    ...
    # Grouping  results by site for display
